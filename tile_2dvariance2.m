...
clc
close all
main_path = 'X:\Einstein\codecentralization\acs\sectionedtissue';
...
sx=size(maskcollagen,1);sy=size(maskcollagen,2);%b1=200;b2=200;b3=300;b4=270;
