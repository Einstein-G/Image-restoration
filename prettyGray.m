function Gray = prettyGray(Intensity,bright,dark)
% prettyGray rescales (0,1) and saturates a single image channel.
...
if nargin < 3, bright = 0.99; end;
if nargin < 2, dark = 0.01; end;
